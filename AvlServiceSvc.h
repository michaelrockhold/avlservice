...
#import "USGlobals.h"
@class AvlServiceSvc_AvlReport;
@class AvlServiceSvc_ArrayOf_xsd_string;
@class AvlServiceSvc_ArrayOfAvlReport;
@interface AvlServiceSvc_AvlReport : NSObject {
...
@end
@interface AvlServiceSvc_ArrayOf_xsd_string : NSObject {
...
- (NSDictionary *)attributes;
@end
@interface AvlServiceSvc_ArrayOfAvlReport : NSObject {
...
@interface AvlServiceSvc : NSObject {
